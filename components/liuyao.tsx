  ...
  return (
    <div className="relative">
      ...
      <Card className="w-full max-w-2xl mx-auto">
        <CardHeader>
          <CardTitle className="text-lg font-bold">六爻解卦</CardTitle>
          <CardDescription>
            <h3 className="text-lg font-bold">一、硬币摇卦法说明</h3>
            <p>1. 一背面两字面：少阳🌱</p>
            <p>2. 两背面一字面：少阴🍃</p>
            <p>3. 三个字面：老阴🌺（变爻）</p>
            <p>4. 三个背面：老阳☀️（变爻）</p>
            <div className="flex items-center space-x-2">
              <img src={COIN_YANG} alt="正面" className="w-6 h-6" /> <img src={RIGHT_ALLOW} alt="右" className="w-6 h-6" /> &nbsp;正面<br />
              <img src={COIN_YIN} alt="反面" className="w-6 h-6" /> <img src={RIGHT_ALLOW} alt="右" className="w-6 h-6" /> &nbsp;反面
            </div>
            <br />
            <h3 className="text-lg font-bold">二、可测内容</h3>
            <div>大象、运势、事业、经商、求名、婚恋、决策、时运、财运、家宅、身体、疾病、胎孕、家运、子女、周转、买卖、等人、寻人、失物、外出、考试、诉讼、求事、改行、开业</div>
            <br />
            <h3 className="text-lg font-bold">三、周易五不测</h3>
